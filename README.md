...
- <img src="https://github.com/favicon.ico" height="14"/> [HALO (GEMMA-by-GOOGLE)](https://github.com/XenoCoreGiger31/GEMMA-by-GOOGLE) - Fully local, autonomous AI penetration-testing agent; a local Gemma model drives a 29-tool MCP server through recon, attack, and reporting.
